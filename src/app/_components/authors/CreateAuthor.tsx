      ...
      >
        <div className="group relative z-0 mb-6">
          ...
          {errors.name && errors.name.type === "required" && (
            <span className="text-red-500">Meno autora/ky je povinné</span>
          )}
        ...
        <div className="group relative z-0 mb-6">
          ...
          {errors.description && errors.description.type === "required" && (
            <span className="text-red-500">Popis je povinný</span>
          )}
        ...
        <div className="group relative z-0 mb-6">
          ...
          />
          {errors.deathYear && errors.deathYear.type === "required" && (
            <span className="text-red-500">Dátum úmrtia musí byť povinný</span>
          )}
        </div>
        <div className="group relative z-0 mb-6">
          <input
          ...
          />
          {errors.birthYear && errors.birthYear.type === "required" && (
            <span className="text-red-500">
        ...
        <div className="group relative z-0 mb-6">
          ...
          />
		  {errors.litPeriod && errors.litPeriod.type === "required" && (
            <span className="text-red-500">
        ...
        <div className="group relative z-0 mb-6">
          ...
          />
		  {errors.authorImage && errors.authorImage.type === "required" && (
            <span className="text-red-500">
        ...
        <div className="group relative z-0 mb-6">
          ...
          />
		  {errors.totalBooks && errors.totalBooks.type === "required" && (
            <span className="text-red-500">
