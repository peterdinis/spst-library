          ...
          <div className="mb-4">
            <div className="mb-2">
              ...
              {errors.name && errors.name.type === "required" && (
                <span className="text-red-500">Meno je povinné</span>
              )}
            ...
            <div className="mb-2">
              ...
              {errors.lastName && errors.lastName.type === "required" && (
                <span className="text-red-500">Priezivsko je povinné</span>
              )}
            ...
            <div className="mb-2">
              ...
              {errors.email && errors.email.type === "required" && (
                <span className="text-red-500">Email je povinný</span>
              )}
            </div>
            ...
            <div className="mb-2">
              ...
              <div className="relative">
                ...
                {errors.password && errors.password.type === "required" && (
                  <span className="text-red-500">Heslo je povinné</span>
                )}
