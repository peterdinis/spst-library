      ...
      >
        <div className="group relative z-0 mb-6">
          ...
          {errors.name && errors.name.type === "required" && (
            <span className="text-red-500">Meno vydavateľstva je povinné</span>
          )}
        ...
        <div className="group relative z-0 mb-6">
          ...
          />
          {errors.createdDated && errors.createdDated.type === "required" && (
            <span className="text-red-500">Dátum je povinný</span>
          )}
        </div>
        <div className="group relative z-0 mb-6">
          <input
        ...
        <div className="group relative z-0 mb-6">
          ...
          {errors.bossName && errors.bossName.type === "required" && (
            <span className="text-red-500">Meno majiteľa je povinné</span>
          )}
          {errors.name && errors.name.type === "minLength" && (
            <span className="text-red-500">
