...
const PublisherSheets: FC<IPublisherSheetProps> = ({ name, data }: IPublisherSheetProps) => {
    ...
    const [publisherDescription, setPublisherDescription] = useState(data?.description || "");
    const [publisherImage, setPublisherImage] = useState(data?.image || "");
    const [publisherBossName, setPublisherBossName] = useState(data?.bossName || "");
    const [publisherIsActive, setPublisherIsActive] = useState(data?.isActive || false);
    const [publisherCreatedDated, setPublisherCreatedDated] = useState(data?.createdDated || "");
                ...
                <div>
                    <form onSubmit={updatePublisherFn}>
                        ...
                        <Input
                            ...
                            onChange={(e: any) => setPublisherCreatedDated(e.target.value)}
                        />
